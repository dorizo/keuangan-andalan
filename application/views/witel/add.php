        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">KODE WITEL</label>
                <input type="text" name="witel_code" id="inputName" class="form-control">
              </div>
              <div class="form-group">
                <label for="inputName">NAMA WITEL</label>
                <input type="text" name="witel_name" id="inputName" class="form-control">
              </div>
