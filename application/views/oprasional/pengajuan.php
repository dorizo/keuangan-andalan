<div class="col-lg-12">
        ...
        <?php print_r($result)?>
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <select name="kategori" class="form-control select2">
                            <option value="">Pilih</option>
                            <option <?=$result->kategori=="Oprasional"?"selected":""?> value="Oprasional">Oprasional</option>
                            <option  <?=$result->kategori=="Oprasional"?"selected":""?> value="Capex">Capex</option>
                </select>
              </div>
                ...
                <select name="witel_id" class="form-control select2">
                            ...
                            <?php
                              foreach ($witel as $key => $value) {
                                $select ="";
                                if($result->witelhoID == $value["witelhoID"] ){
                                    $select ="selected";  
                                }
                              echo "<option $select value='".$value["witelhoID"]."'>".$value["witelhoName"]."</option>";
                              }
                            ?>
                </select>
              </div>
                ...
                <select  name="stoCode" class="form-control select2">
                            ...
                            <?php
                              foreach ($sto as $key => $value) {
                                $select ="";
                                if($result->stoCode == $value["stoCode"] ){
                                    $select ="selected";  
                                }
                              echo "<option $select value='".$value["stoCode"]."'>".$value["stoName"]."</option>";
                              }
                            ?>
                </select>
              </div>
                ...
                <select  name="pekerjaanCode" class="form-control select2">
                            ...
                            <?php
                              foreach ($Pekerjaan as $key => $value) {
                                $select ="";
                                if($result->pekerjaanCode == $value["pekerjaanCode"] ){
                                    $select ="selected";  
                                }
                              echo "<option $select value='".$value["pekerjaanCode"]."'>".$value["pekerjaanName"]."</option>";
                              }
                            ?>
                </select>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="hidden" name="orCode" value="<?=$orCode?>" id="inputName" class="form-control">
              ...
              <div class="form-group">
                ...
                <input type="text" name="keterangan" value="<?=$result->keterangan?>" id="inputName" class="form-control">
              </div>
            ...
            <div class="form-group">
                ...
                <input type="tel" name="kredit" id="kredit" value="<?=$result->kredit?>" class="form-control" readonly>
              </div>
