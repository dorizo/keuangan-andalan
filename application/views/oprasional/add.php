<div class="col-lg-12">
        <div class="card card-primary">
            ...
            <div class="form-group">
                ...
                <select name="kategoriakutansi" class="form-control select2">
                            <option value="">Pilih</option>
              ...
              <div class="form-group">
                ...
                <input type="number" name="debit" id="inputName" class="form-control">
              </div>
            <div class="form-group">
                <label for="inputName">kredit</label>
                <input type="number" name="kredit" id="inputName" class="form-control">
              </div>
