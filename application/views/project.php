                    ...
                    <tr class="odd">
                      ...
                      <div class="btn-group dropleft">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <?=projectmenu("CPRO",base_url("mandor/sematkan/".$value["project_id"]) , "fa-money-bill" , "Setting Karyawan")?>
                          ...
                          <?=projectmenublank("KEUW","https://karyawan.ciptateknologimuda.com/projectrequest/request/".$value["project_id"]."?".http_build_query($this->session->userdata())  , "fa-money-bill" , "setting Request Budget" ,)?>
