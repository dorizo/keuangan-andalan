          ...
          <div class="card-header">
            ...
            <form  method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="hidden" name="designator_package_id" value="<?= $editpackage->designator_package_id ?>">
                  ...
                  <select class="permission select2bs4" data-placeholder="Select a role" name="package_id" style="width: 100%;" required="required">
                    ...
                    if(!empty($permission)){
                      foreach($permission as $value){
                        $xx = $editpackage->package_id==$value->package_id?"selected":"";
                        echo "<option $xx value='$value->package_id' select>$value->package_name</option>";
                      }}
                      ?>
                  </select>
                  <br />
                  <b>material price</b>
                  <input type="text" name="material_price" value="<?=$editpackage->material_price?>" class="form-control number-separator" />
                  <br />
                  <b>service price</b>
                  <input type="text" name="service_price" value="<?=$editpackage->service_price?>" class="form-control number-separator" />
